...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $customMessages = [
            'code.required' => 'NIM belum diisi!',
            'study_program_id.required' => 'Program studi belum diisi!',
        ...
        return redirect('/students')->with('message', 'Data telah ditambahkan');
    }
    ...
    {
        $data['pageTitle'] = 'Ubah Data Mahasiswa';
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->password == null) {
            ...
            return redirect('/students')->with('message', 'Data telah diubah');
        } else {
            $user = User::find($user->id);
            $user->update([
                'code' => $request->code,
    ...
    public function destroy($id)
    {
        ...
        $onActivities = Activities::where('student_id', $user->id)->get();

        if ($onActivities->count() > 0) {
            return redirect('/students')->with('message', 'Data tidak dapat dihapus karena sedang mengikuti kegiatan');
        }

        User::destroy($id);

        return redirect('/students')->with('message', 'Data telah dihapus');
    }
}
