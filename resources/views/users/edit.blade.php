                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ url('/users/' .$user->id) }}" class="needs-validation" novalidate="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="code" type="text" class="form-control @error('code') is-invalid @enderror" value="{{ old('code', $user->code) }}">
                                    @error('code')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="study_program_id" class="form-control selectric @error('study_program_id') is-invalid @enderror">
                                        <option value="">Pilih Program Studi</option>
                                        @foreach ($studyprograms as $studyprogram)
                                            <option value="{{ $studyprogram->id }}" {{ old('study_program_id', $user->study_program_id) == $studyprogram->id ? 'selected' : '' }}>{{ $studyprogram->name }}</option>
                                        @endforeach
                                    </select>
